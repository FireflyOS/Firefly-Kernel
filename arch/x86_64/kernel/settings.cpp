...
namespace firefly::kernel::settings {
    ...
    */
    ...
    namespace get {
        uint8_t kernel_mode(void){ return kernel_settings[0]; }
        uint8_t enable_serial_port(void){ return kernel_settings[1]; }
        uint8_t disable_app_access_rights(void){ return kernel_settings[2]; }
        uint8_t disable_memory_block_access_rights(void){ return kernel_settings[3]; }
        uint8_t block_count(void){ return kernel_settings[4]; }
    }
}